...
<body>
 <header style="background-color:lightpink;" id="header" class="fixed-top">
    <div class="container d-flex align-items-center">

      <h1 class="logo mr-auto"><a style="color:white" href="index.php">Programlama Bloğum</a></h1>
       <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a style="color:white" href="index.php">Anasayfa</a></li>
          <li><a style="color:white" href="hakkimizda.php">Hakkımızda</a></li>
          <li><a style="color:white" href="ekip.php">Ekibimiz</a></li>
          <li><a style="color:white" href="galeri.php">Galeri</a></li>
